...
const blogPosts = [
    ...
    },
    {
        ...
        content: [
            "今回はインフィニティリングにも挑戦！",
            "そしてまだまだスワロフスキーのブローチも人気です。",
            "今回はプレゼント用にブローチとのことでしたが、自分用にも",
            "またプレゼントにもと、作る目的はそれぞれです。大切に作った作品が",
            "それぞれのもとでまた大切に使われますように。。。♥",
            "次回の開催は7/4(土)10：30～です。また次回もどうぞよろしくお願いします。"
        ]
    },
        {
        id: 7,
        title: "夏は大ぶりのアクセサリーを着けたくなります♪",
        date: "7/4",
        year: "2026",
        category: "活動報告",
        ...
        content: [
            "久しぶりに参加されたMさん",
            "大ぶりのネックレスを仕上げて着画をいただきました！",
            "またリングも引き続き人気で、インフィニティリングにエタニティリング",
            "どちらもキレイに仕上がりました！",
            "涼し気なブレスレットやトルコパーツの水色ハートのトップのネックレスもとっても可愛かったです♥",
            "次回の開催は9月です。(8月は夏休み)また次回もどうぞよろしくお願いします。"
        ]
    },
        {
        id: 8,
        title: "「いつもと違う」とまた違う素敵なことが起きました！！",
        date: "9/13",
        year: "2026",
        category: "活動報告",
        image: "images/2026July workshop.png",
        ...
        content: [
            "いつもは土曜日の開催なのですが",
            "私の都合で日曜開催にしたところ、普段土曜に来れないY親子が逆に来られるようになり",
            "久しぶりにご参加いただきました。なんと1年ぶりの参加！！",
            "久しぶりにお会いできてうれしかったです(*´▽｀*)♪",
            "8月はイベントへの参加もあり教室はお休みだったので、久しぶりの先生のお料理（しかも私の大好きなカレー）は格別でした♥",
            "次回の開催は10月です。やっと涼しくなってきたので芸術の秋になりましたね、また次回もどうぞよろしくお願いします。"
        ]
    },
];  // ← ここで配列を閉じる！
